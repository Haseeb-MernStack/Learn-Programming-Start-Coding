...
const Testimonial = () => {
  return (
    <div class="text-center h-[550px] w-full p-5 mt-5">
      ...
      <div class="flex flex-wrap justify-center gap-5 mt-16 text-left">
        ...
        <div class="w-80 flex flex-col items-start border border-gray-500/30 p-5 rounded-lg bg-white">
          ...
          <div class="flex items-center gap-3 mt-4">
            ...
            />
            <div>
              <h2 class="text-lg text-gray-900 font-medium">Richard Nelson</h2>
              <p class="text-sm text-gray-500">SWE 2 @ Amazon</p>
            </div>
          </div>
        </div>
        ...
        <div class="w-80 flex flex-col items-start border border-gray-500/30 p-5 rounded-lg bg-white">
          ...
          <div class="flex items-center gap-3 mt-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">SWE 2 @ Google</p>
            </div>
          </div>
        </div>
      </div>
